					...
					<v-card>
						...
						<v-card-text>
							<v-layout class="pt-5 pl-3">
								<v-flex v-if="item.close != 0">
									<v-row class="font-weight-bold"
										>스트리머 : {{ item.celebrity }}</v-row
									>
									<v-row class="font-weight-bold"
									...
									<v-row
										...
										align="center"
										><v-col cols="auto"
											><v-chip color="green">발행됨</v-chip></v-col
										></v-row
									>
								</v-flex>
								<v-flex v-else-if="item.cancel != 0">
									<v-row class="font-weight-bold"
										>스트리머 : {{ item.celebrity }}</v-row
									>
									<v-row class="font-weight-bold"
									...
									<v-row
										...
										align="center"
										><v-col cols="auto"
											><v-chip color="red accent-2">취소됨</v-chip></v-col
										></v-row
									>
								</v-flex>
								<v-flex v-else-if="item.cancel == 0 && item.close == 0">
									<v-row class="font-weight-bold"
										>스트리머 : {{ item.celebrity }}</v-row
									>
									<v-row class="font-weight-bold"
									...
									<v-row
										...
										align="center"
										><v-col cols="auto"
											><v-chip color="lime">승인 대기중</v-chip></v-col
										></v-row
									>
								</v-flex>
							</v-layout>
...
export default {
	...
	methods: {
		...
		p: function (x) {
			console.log("aaa", this.tokenInfos.__ob__.value);
		},
	},
};
</script>
