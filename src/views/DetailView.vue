        ...
        <v-col sm="8" id="detail-box" justify="center" align="center">
          <v-col id="img-box">
            <v-card id="IMG-BG" color="rgb(177, 204, 255)" dark tile flat>
              <img id="IMG" v-bind:src="now.image"/>
            </v-card>
          </v-col>
          <v-col id="title-box">
            <table style="margin-top: 48px;">
              ...
              <tr>
                ...
                <v-card-text class="ntitle" style="width:48rem">
                  <v-row align="center">
                    <v-col cols="10">
                      {{ now.name }}
                    ...
                    <v-col cols="2">
                      <v-btn
                          :href="`https://testnets.opensea.io/assets/baobab/${now.tokenContractAddress}/${now.tokenId}`"
                          icon
                          target="_blank">
                        <svg width="131" height="auto" viewBox="0 0 437 100"
                             fill="none"
                             class="float-left">
                          <path
                              d="M100 50C100 77.6127 77.6127 100 50 100C22.3873 100 0 77.61 27 0 50C0 22.3873 22.3873 0 50 0C77.6185 0 100 22.3873 100 50Z"
                              fill="#2081E2"/>
                          <path
                      ...
                      <tr class="producer">
                        ...
                        <button @click="test(index)" v-clipboard:copy="now.contractOwner">
                          <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                              ...
                              id="image0" width="30" height="30" x="0" y="0"
                              href="data:image/png;base64,"/>
                        </svg>
                        </button>
                      </tr>
                      </tbody>
          ...
          <v-col id="des-box">
            ...
            <v-row flat align="center" justify="center">
              <v-card v-if="slice >= 3" style="vertical-align: middle;" flat>
                <v-btn class="" height="48" dark @click="slice-=3">
                  <v-icon dark>
                    mdi-arrow-left
                  </v-icon>
                </v-btn>
  ...
  methods: {
    getNFTByContractAddress: function () {
      return new Promise(resolve => {
        Connection.getNFTByContractAddress(this.$route.params.contractAddress).then(NFTs => {
